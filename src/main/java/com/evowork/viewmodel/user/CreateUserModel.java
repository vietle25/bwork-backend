...
public class CreateUserModel {
    ...
    private String socialId; //Id social
    private Integer gender; // Gender
    private String token; //Token
    private String rememberToken;//Remember token
    private Timestamp birthDate; //Birth date
    private String password; //Password using for create account
    private String email; //Email
    private Integer userType; // 2: internal users, 0 admin web
    private String avatarPath; //Avatar
    private boolean updatePhone; // for update phone social
    private String personalId; //personal Id
    private String domicile; //personal Id
